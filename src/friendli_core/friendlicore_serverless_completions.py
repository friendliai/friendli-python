...
class BaseFriendliCoreServerlessCompletions(BaseSDK):
    pass


class SyncFriendliCoreServerlessCompletions(
    BaseFriendliCoreServerlessCompletions, SyncSDK
):
    def complete(
        self,
        *,
...
class AsyncFriendliCoreServerlessCompletions(
    BaseFriendliCoreServerlessCompletions, AsyncSDK
):
    async def complete(
        self,
        *,
