...
class BaseFriendliCoreToken(BaseSDK):
    pass


class SyncFriendliCoreToken(BaseFriendliCoreToken, SyncSDK):
    def tokenization(
        self,
        *,
        model: str,
...
class AsyncFriendliCoreToken(BaseFriendliCoreToken, AsyncSDK):
