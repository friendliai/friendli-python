...
RequestBodyTypedDict = TypeAliasType("RequestBodyTypedDict", Union[str, Dict[str, Any]])


RequestBody = TypeAliasType("RequestBody", Union[str, Dict[str, Any]])


class UpdateSamplesRequestTypedDict(TypedDict):
    dataset_id: int
    r"""ID of the dataset."""
    split_id: int
    r"""ID of the split."""
    request_body: List[List[RequestBodyTypedDict]]
