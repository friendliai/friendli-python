...
class SyncDataset(BaseDataset, SyncSDK):
    def create_dataset(
        ...
        *,
        ...
        request = models.CreateDatasetRequest1(
            ...
            create_dataset_request=models.CreateDatasetRequest(name=name),
        )
    ...
    def list_datasets(
        ...
        *,
        ...
        request = models.ListDatasetsRequest(
            cursor=cursor, limit=limit, x_friendli_team=x_friendli_team
        )
        req = self._build_request(
            method="GET",
            path="/beta/dataset/",
    ...
    def delete_version(
        ...
        *,
        ...
        req = self._build_request(
            method="DELETE",
            path="/beta/dataset/{dataset_id}/split/{split_id}/version/{version_id}",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
    ...
    def revert_dataset(
        ...
        *,
        ...
        if server_url is not None:
            ...
            base_url = self._get_url(base_url, url_variables)
        request = models.RevertDatasetRequest(
            dataset_id=dataset_id,
            version_id=version_id,
            x_friendli_team=x_friendli_team,
        )
        req = self._build_request(
            method="POST",
            path="/beta/dataset/{dataset_id}/revert",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
    ...
    def add_samples(
        ...
        *,
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.request_body, False, False, "json", List[Dict[str, Any]]
            ),
            timeout_ms=timeout_ms,
        )
        if retries == UNSET:
    ...
    def update_samples(
        ...
        *,
        ...
        if server_url is not None:
            ...
            base_url = self._get_url(base_url, url_variables)
        request = models.UpdateSamplesRequest(
            dataset_id=dataset_id,
            split_id=split_id,
            x_friendli_team=x_friendli_team,
            request_body=request_body,
