...
class BaseFriendliCoreServerlessToken(BaseSDK):
    pass


class SyncFriendliCoreServerlessToken(BaseFriendliCoreServerlessToken, SyncSDK):
    def tokenization(
        self,
        *,
        model: str,
...
class AsyncFriendliCoreServerlessToken(BaseFriendliCoreServerlessToken, AsyncSDK):
