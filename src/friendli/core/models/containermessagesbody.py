...
ContainerMessagesBodySystemTypedDict = TypeAliasType(
...
ContainerMessagesBodySystem = TypeAliasType(
    "ContainerMessagesBodySystem", Union[str, List[MessagesSystemTextBlock]]
)
"Payload format for the top-level `system` instruction."
ContainerMessagesBodyServiceTierTypedDict = TypeAliasType(
    "ContainerMessagesBodyServiceTierTypedDict", Union[str, Dict[str, Any]]
)
"Compatibility field accepted for request portability. Parsed but not used for generation."
ContainerMessagesBodyServiceTier = TypeAliasType(
    "ContainerMessagesBodyServiceTier", Union[str, Dict[str, Any]]
)
"Compatibility field accepted for request portability. Parsed but not used for generation."


class ContainerMessagesBodyTypedDict(TypedDict):
    ...
    system: NotRequired[Nullable[ContainerMessagesBodySystemTypedDict]]
    ...
    "Compatibility field accepted for request portability. Parsed but not used for generation."
    service_tier: NotRequired[Nullable[ContainerMessagesBodyServiceTierTypedDict]]
    "Compatibility field accepted for request portability. Parsed but not used for generation."


class ContainerMessagesBody(BaseModel):
    ...
    "Routes the request to a specific adapter."
    system: OptionalNullable[ContainerMessagesBodySystem] = UNSET
    "Optional top-level system instruction applied before conversation turns. Supports a plain string or an array of text blocks."
    ...
    "Compatibility field accepted for request portability. Parsed but not used for generation."
    service_tier: OptionalNullable[ContainerMessagesBodyServiceTier] = UNSET
    "Compatibility field accepted for request portability. Parsed but not used for generation."
