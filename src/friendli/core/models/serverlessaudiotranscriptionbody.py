...
class ServerlessAudioTranscriptionBodyFileTypedDict(TypedDict):
    file_name: str
    content: Union[bytes, IO[bytes], io.IOBase]
    content_type: NotRequired[str]


class ServerlessAudioTranscriptionBodyFile(BaseModel):
    file_name: Annotated[
...
ServerlessAudioTranscriptionBodyChunkingStrategyTypedDict = TypeAliasType(
...
ServerlessAudioTranscriptionBodyChunkingStrategy = TypeAliasType(
...
class ServerlessAudioTranscriptionBodyTypedDict(TypedDict):
    ...
    chunking_strategy: NotRequired[
        Nullable[ServerlessAudioTranscriptionBodyChunkingStrategyTypedDict]
    ]
    'Controls how the audio is cut into chunks. When set to `\\"auto\\"`, the server first normalizes loudness and then uses voice activity detection (VAD) to choose boundaries. `server_vad` object can be provided to tweak VAD detection parameters manually. If unset, the audio is transcribed as a single block.'
...
class ServerlessAudioTranscriptionBody(BaseModel):
    ...
    chunking_strategy: Annotated[
        OptionalNullable[ServerlessAudioTranscriptionBodyChunkingStrategy],
