...
ContainerMessagesSuccessStopReason = Literal[
    "end_turn", "max_tokens", "tool_use", "stop_sequence"
]


class ContainerMessagesSuccessTypedDict(TypedDict):
    id: str
    ...
    stop_reason: NotRequired[Nullable[ContainerMessagesSuccessStopReason]]
...
class ContainerMessagesSuccess(BaseModel):
    ...
    "Role of the output message author (`assistant`)."
    stop_reason: OptionalNullable[ContainerMessagesSuccessStopReason] = UNSET
    "Why generation stopped (`end_turn`, `max_tokens`, `tool_use`, `stop_sequence`)."
...
try:
    ContainerMessagesSuccess.model_rebuild()
except NameError:
    pass
