...
ServerlessMessagesSuccessStopReason = Literal[
    "end_turn", "max_tokens", "tool_use", "stop_sequence"
]


class ServerlessMessagesSuccessTypedDict(TypedDict):
    id: str
    ...
    stop_reason: NotRequired[Nullable[ServerlessMessagesSuccessStopReason]]
...
class ServerlessMessagesSuccess(BaseModel):
    ...
    "Role of the output message author (`assistant`)."
    stop_reason: OptionalNullable[ServerlessMessagesSuccessStopReason] = UNSET
    "Why generation stopped (`end_turn`, `max_tokens`, `tool_use`, `stop_sequence`)."
...
try:
    ServerlessMessagesSuccess.model_rebuild()
except NameError:
    pass
