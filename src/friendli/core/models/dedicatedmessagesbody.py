...
DedicatedMessagesBodySystemTypedDict = TypeAliasType(
...
DedicatedMessagesBodySystem = TypeAliasType(
    "DedicatedMessagesBodySystem", Union[str, List[MessagesSystemTextBlock]]
)
"Payload format for the top-level `system` instruction."
DedicatedMessagesBodyServiceTierTypedDict = TypeAliasType(
    "DedicatedMessagesBodyServiceTierTypedDict", Union[str, Dict[str, Any]]
)
"Compatibility field accepted for request portability. Parsed but not used for generation."
DedicatedMessagesBodyServiceTier = TypeAliasType(
    "DedicatedMessagesBodyServiceTier", Union[str, Dict[str, Any]]
)
"Compatibility field accepted for request portability. Parsed but not used for generation."


class DedicatedMessagesBodyTypedDict(TypedDict):
    ...
    "Compatibility field accepted for request portability. Parsed but not used for generation."
    service_tier: NotRequired[Nullable[DedicatedMessagesBodyServiceTierTypedDict]]
    "Compatibility field accepted for request portability. Parsed but not used for generation."


class DedicatedMessagesBody(BaseModel):
    ...
    "Compatibility field accepted for request portability. Parsed but not used for generation."
    service_tier: OptionalNullable[DedicatedMessagesBodyServiceTier] = UNSET
    "Compatibility field accepted for request portability. Parsed but not used for generation."
