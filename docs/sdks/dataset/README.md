...
* [revert_dataset](#revert_dataset) - Revert dataset
...
with SyncFriendli(
    ...
    res = friendli.dataset.create_dataset(name="<value>")
...
with SyncFriendli(
    ...
    res = friendli.dataset.list_datasets()
...
| ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- |
| `dataset_id`                                                        | *int*                                                               | :heavy_check_mark:                                                  | ID of the dataset.                                                  |
| `version_id`                                                        | *int*                                                               | :heavy_check_mark:                                                  | ID of the version to get.                                           |
| `x_friendli_team`                                                   | *OptionalNullable[str]*                                             | :heavy_minus_sign:                                                  | ID of team to run requests as (optional parameter).                 |
| `retries`                                                           | [Optional[utils.RetryConfig]](../../models/utils/retryconfig.md)    | :heavy_minus_sign:                                                  | Configuration to override the default retry behavior of the client. |
...
with SyncFriendli(
    ...
    res = friendli.dataset.delete_version(
        dataset_id=310482, split_id=944306, version_id=434150
    )
...
with SyncFriendli(
    ...
    res = friendli.dataset.revert_dataset(dataset_id=147267, version_id="<id>")
...
| `dataset_id`                                                        | *int*                                                               | :heavy_check_mark:                                                  | ID of the dataset.                                                  |
| `split_id`                                                          | *int*                                                               | :heavy_check_mark:                                                  | ID of the split.                                                    |
| `request_body`                                                      | List[Dict[str, *Any*]]                                              | :heavy_check_mark:                                                  | N/A                                                                 |
| `x_friendli_team`                                                   | *OptionalNullable[str]*                                             | :heavy_minus_sign:                                                  | ID of team to run requests as (optional parameter).                 |
| `retries`                                                           | [Optional[utils.RetryConfig]](../../models/utils/retryconfig.md)    | :heavy_minus_sign:                                                  | Configuration to override the default retry behavior of the client. |
