...
<!-- UsageSnippet language="python" operationID="init_upload" method="post" path="/beta/file" -->
```python
import os
...
<!-- UsageSnippet language="python" operationID="complete_upload" method="patch" path="/beta/file/{file_id}" -->
```python
import os
